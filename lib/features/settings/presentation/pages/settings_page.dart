...
import 'package:noteflow/shared/widgets/setting_tile.dart';
      ...
      body: ListView(
        children: [
          ...
          const AboutListTile(
            ...
            aboutBoxChildren: [
              Text('Local-first note app with lightweight clean architecture.'),
            ],
          ),
          const SettingTile(
            title: 'Backup / Export / Import',
            subtitle: 'Placeholder for future implementation',
          ),
        ],
      ),
    );
